        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceOwners_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 3, 10, null, null, false, 3600, "Guest" });

            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "Id", "DeletedOn", "DisplayName", "FriendlyName", "HwId", "Manufacturer", "OS" },
                values: new object[] { 1, null, "DESKTOP-1QEA880", null, "220909805201092", null, null });
